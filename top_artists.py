...
class ExternalStreams(luigi.ExternalTask):
    ...
    def output(self):
        ...
        """
        return luigi.contrib.hdfs.HdfsTarget(self.date.strftime('tmp/streams_%Y-%m-%d.tsv'))
...
class Streams(luigi.Task):
    ...
    def output(self):
        ...
        :rtype: object (:py:class:`luigi.target.Target`)
        """
        return luigi.LocalTarget(self.date.strftime('tmp/streams_%Y_%m_%d_faked.tsv'))
...
class StreamsHdfs(Streams):
    ...
    def output(self):
        ...
        :rtype: object (:py:class:`luigi.target.Target`)
        """
        return luigi.contrib.hdfs.HdfsTarget(self.date.strftime('tmp/streams_%Y_%m_%d_faked.tsv'))
...
class AggregateArtists(luigi.Task):
    ...
    def output(self):
        ...
        :rtype: object (:py:class:`luigi.target.Target`)
        """
        return luigi.LocalTarget("tmp/artist_streams_{}.tsv".format(self.date_interval))
...
class AggregateArtistsSpark(luigi.contrib.spark.SparkSubmitTask):
    ...
    def output(self):
        ...
        :rtype: object (:py:class:`luigi.target.Target`)
        """
        return luigi.contrib.hdfs.HdfsTarget("tmp/artist_streams_%s.tsv" % self.date_interval)
...
class Top10Artists(luigi.Task):
    ...
    def output(self):
        ...
        :rtype: object (:py:class:`luigi.target.Target`)
        """
        return luigi.LocalTarget("tmp/top_artists_%s.tsv" % self.date_interval)
